...
HD_PWD='D:/QFT_Bit/pipeline_reduced_qft/pipeline_reduced_1/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log qft3_top_pipelined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source qft3_top_pipelined.tcl -notrace
