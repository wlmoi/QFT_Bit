...
HD_PWD='D:/QFT_Bit/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_lut_8_segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_lut_8_segment.tcl
