...
HD_PWD='D:/QFT_Bit/QFT_Bit/QFT_Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_complelx_utils.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fixed_complelx_utils.tcl
